...
class ModelStats:
    ...
    def log_data(self, step, images=True):
        ...
        if images:
            ...
            size = sys.getsizeof(trajectory)
            print(len(trajectory),'and ',size,  'is length and size  of the trajectory.....................................................................')
    ...
    def save_if_best(self):
        if len(self.evaluation_deque) < self.params.moving_average_length:
            # print(self.evaluation_deque, self.params.moving_average_length)
            return #print('Moving avg is still smaller than threshold moving average length, which is 50')
